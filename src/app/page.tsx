      ...
      <main className='relative pb-24 pl-4 lg:pl-16'>
        <div className='flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12'>
          <div className='absolute left-0 top-0 -z-10 flex h-[95vh] w-screen flex-col bg-black'>
            <Image src='/banner.jpg' alt='the witcher' fill={true} className="h-[65vh] object-cover object-top lg:h-[95vh]"/>
          </div>
          ...
          <p className='max-w-xs text-xs shadow-md md:max-w-lg md:text-lg lg:max-w-2xl'>
            Beralt of Rivia, a solitary monster hunter, struggles to find his
